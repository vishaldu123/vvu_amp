<?php echo form_open('page/edit/'.$page['id'],array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<select name="catid" class="form-control">
				...
				{
					$selected = ($value == $page['catid']) ? ' selected="selected"' : "";
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<select name="featured" class="form-control">
				...
				{
					$selected = ($value == $page['featured']) ? ' selected="selected"' : "";
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="alias" value="<?php echo ($this->input->post('alias') ? $this->input->post('alias') : $page['alias']); ?>" class="form-control" id="alias" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="access" value="<?php echo ($this->input->post('access') ? $this->input->post('access') : $page['access']); ?>" class="form-control" id="access" />
		</div>
	</div>
	<div class="form-group">
		<label for="hits" class="col-md-4 control-label">Hits</label>
		<div class="col-md-8">
			<input type="text" name="hits" value="<?php echo ($this->input->post('hits') ? $this->input->post('hits') : $page['hits']); ?>" class="form-control" id="hits" />
		</div>
	</div>
	<div class="form-group">
		<label for="fulltext" class="col-md-4 control-label">Fulltext</label>
		<div class="col-md-8">
			<textarea name="fulltext" class="form-control" id="fulltext"><?php echo ($this->input->post('fulltext') ? $this->input->post('fulltext') : $page['fulltext']); ?></textarea>
		</div>
	</div>
	<div class="form-group">
		<label for="images" class="col-md-4 control-label">Images</label>
		<div class="col-md-8">
			<textarea name="images" class="form-control" id="images"><?php echo ($this->input->post('images') ? $this->input->post('images') : $page['images']); ?></textarea>
		</div>
	</div>
	<div class="form-group">
		<label for="urls" class="col-md-4 control-label">Urls</label>
		<div class="col-md-8">
			<textarea name="urls" class="form-control" id="urls"><?php echo ($this->input->post('urls') ? $this->input->post('urls') : $page['urls']); ?></textarea>
		</div>
	</div>
	<div class="form-group">
		<label for="metakey" class="col-md-4 control-label">Metakey</label>
		<div class="col-md-8">
			<textarea name="metakey" class="form-control" id="metakey"><?php echo ($this->input->post('metakey') ? $this->input->post('metakey') : $page['metakey']); ?></textarea>
		</div>
	</div>
	<div class="form-group">
		<label for="metadesc" class="col-md-4 control-label">Metadesc</label>
		<div class="col-md-8">
			<textarea name="metadesc" class="form-control" id="metadesc"><?php echo ($this->input->post('metadesc') ? $this->input->post('metadesc') : $page['metadesc']); ?></textarea>
		</div>
	</div>
	<div class="form-group">
		<label for="metadata" class="col-md-4 control-label">Metadata</label>
		<div class="col-md-8">
			<textarea name="metadata" class="form-control" id="metadata"><?php echo ($this->input->post('metadata') ? $this->input->post('metadata') : $page['metadata']); ?></textarea>
		</div>
	</div>
